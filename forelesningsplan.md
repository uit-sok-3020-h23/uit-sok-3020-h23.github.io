...
|   |   | Example P.2 Calculating a conditional probability [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.3 Calculating an expected value  [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.4 Calculating a Conditional Expectation  [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.5 Calculating a Variance  [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.6 Calculating a Correlation [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.7 Conditional Expectation  [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.8 Conditional Variance  [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.9 Iterated Expectation  [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.10 Covariance Decomposition  [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
|   |   | Example P.11 Normal Distribution Probability Calculation  [Rcode](){:target='_blank_'}  [video](){:target='_blank_'}   |  
