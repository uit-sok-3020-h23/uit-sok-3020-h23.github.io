...
Find installation files for your OS at:
...
-   Use RStudio, an Integrated Development Environment (IDE) developed by [posit](http://www.posit.co)
[**Download for local installation**](https://posit.co/download/rstudio-desktop/)
-   Jupyter notebook using web-browser, use UiT username/password
<https://jupyter.uit.no>
...
We can also access variables directly by using their names, either with **object[ , "variable"]** notation
or **object$variable** notation
