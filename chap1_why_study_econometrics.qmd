...
$$ 1) \;\; Q=f(P_{1},P_{2},INC) $$
$$ 2) \;\; Q=f(P_{1},P_{2},INC)+e $$
$$ 3) \;\; Q(P_{1},P_{2},INC)=\beta_{1}+\beta_{2}P_{1}+\beta_{3}P_{2}+\beta_{4}INC $$
$$ 4) \;\; Q=\beta_{1}+\beta_{2}P_{1}+\beta_{3}P_{2}+\beta_{4}INC+e $$
$$ 5) \;\; E(Q|P_{1},P_{2},INC)=\beta_{1}+\beta_{2}P_{1}+\beta_{3}P_{2}+\beta_{4}INC$$
